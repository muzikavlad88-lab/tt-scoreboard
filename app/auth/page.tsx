    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-black select-none touch-manipulation">
      <div className="w-full max-w-sm space-y-8 animate-in fade-in duration-700">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-black text-white uppercase tracking-tighter italic italic drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
            ...
            <div className="space-y-3 animate-in slide-in-from-top-4 duration-500">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-zinc-900/50 border border-white/5 p-4 pl-12 rounded-2xl text-white text-sm outline-none focus:border-blue-500 transition-all"
                  required
                />
              </div>
              ...
              <div className="flex gap-2">
                ...
                <div className="relative w-1/2">
                  <input 
                    ...
                    className="w-full bg-zinc-900/50 border border-white/5 p-4 rounded-2xl text-white text-sm outline-none focus:border-blue-500 transition-all"
                    required
                  />
                </div>
              </div>
...
// Захист від SSR помилок при білді
